...
def default_output_dir() -> Path:
    ...
    return Path.home() / "SimOutput" / "dde_health_check" / timestamp
        ...
        (
            ...
            render_dde_execute_script(
                ...
                [
                    ...
                    r"# Always minimize temporarily to test FBO, regardless of current window state.",
                    r"# The capture script also minimizes before using FBO, so this is representative.",
                    ...
                    r"    FBO delete $fbo",
                    r"} fbo_msg]",
                    r"# Restore original window state",
                    r"if {$orig_state ne {iconic}} {",
