        ...
        for attempt in range(attempt_count):
            ...
            script_text = render_dde_execute_script(
                ...
                [
                    ...
                    "}",
                    "# --- persistent FBO (reused across captures, viewport dims) ---",
                    "if {![info exists ::calib_fbo] || $::calib_fbo eq \"\"} {",
                    "    set ::calib_fbo [FBO new $vp_w $vp_h -tex rgb -noclear]",
                    "    set ::calib_fbo_w $vp_w",
                    "    set ::calib_fbo_h $vp_h",
                    "} elseif {![info exists ::calib_fbo_w] || $vp_w != $::calib_fbo_w || $vp_h != $::calib_fbo_h} {",
