    ...
    result = run_check_attempt(
        ...
        script_text=render_dde_execute_script(
            ...
            [
                ...
                '    set wno 0',
                '}',
                '# --- Skip View::SetSize if view already has target dimensions ---',
                '# Prevents C++-level Configure -> ConfigFBO corruption.',
                ...
                '    puts "DIAG_SKIP_ENSURE: view already $__cur_w x$__cur_h"',
                '} else {',
