set __copilot_out_5fa53fef45ed4795a486982bf37e957d [open "tmp/render_diag/t5_after.txt" w]
set __copilot_remote_result_path "tmp/render_diag/t5_after.txt.remote"
catch {file delete -force $__copilot_remote_result_path}
set rc [catch {
    package require dde
    dde execute TclEval IPG-MOVIE {
        set __copilot_remote_out [open "tmp/render_diag/t5_after.txt.remote" w]
...
if {[file exists $__copilot_remote_result_path]} {
    ...
    puts -nonewline $__copilot_out_5fa53fef45ed4795a486982bf37e957d $__copilot_remote_payload
    catch {file delete -force $__copilot_remote_result_path}
} else {
    puts $__copilot_out_5fa53fef45ed4795a486982bf37e957d "rc=$rc"
    puts $__copilot_out_5fa53fef45ed4795a486982bf37e957d "msg_begin"
    puts $__copilot_out_5fa53fef45ed4795a486982bf37e957d $msg
    puts $__copilot_out_5fa53fef45ed4795a486982bf37e957d "msg_end"
}
close $__copilot_out_5fa53fef45ed4795a486982bf37e957d
