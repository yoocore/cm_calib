set out [open "C:/CM_Projects/CMO141_Calibration/Data/Script/CameraCalibration/tmp/view_check/fbo_12321544.txt" w]
set rc [catch {
    package require dde
    dde execute TclEval CarMaker {
        set out2 [open "C:/CM_Projects/CMO141_Calibration/Data/Script/CameraCalibration/tmp/view_check/fbo_12321544.txt.remote" w]
        set rc2 [catch {
