        ...
        for attempt in range(attempt_count):
            ...
            script_text = render_dde_execute_script(
                ...
                [
                    ...
                    "# --- Ensure View array element exists (may be deleted during camera switch) ---",
                    "if {![info exists View($vno_int)]} {",
                    "    set View($vno_int) [dict create Width $vp_w Height $vp_h]",
                    "    puts $__copilot_remote_out \"DIAG: initialized missing View($vno_int)\"",
                    "}",
