set __copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 [open "C:/CM_Projects/CMO141_Calibration/Data/Script/CameraCalibration/tmp/view_check/fbo_result.txt" w]
set __copilot_remote_result_path "C:/CM_Projects/CMO141_Calibration/Data/Script/CameraCalibration/tmp/view_check/fbo_result.txt.remote"
catch {file delete -force $__copilot_remote_result_path}
set rc [catch {
    package require dde
    dde execute TclEval CarMaker {
        set __copilot_remote_out [open "C:/CM_Projects/CMO141_Calibration/Data/Script/CameraCalibration/tmp/view_check/fbo_result.txt.remote" w]
...
if {[file exists $__copilot_remote_result_path]} {
    ...
    puts -nonewline $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 $__copilot_remote_payload
    catch {file delete -force $__copilot_remote_result_path}
} else {
    puts $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 "rc=$rc"
    puts $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 "msg_begin"
    puts $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 $msg
    puts $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204 "msg_end"
}
close $__copilot_out_6a94cf18a30b4ebca410e8f87dcbc204
