...
class CameraCalibrator(DetectorMixin, ScoringMixin, AnnotationMixin, ScriptControlMixin, EvaluateMixin, CoordinateDescentMixin, BayesianOptimizerMixin, StrategyMixin):
