        ...
        for attempt in range(attempt_count):
            ...
            script_text = render_dde_execute_script(
                ...
                [
                    ...
                    "}",
                    "# --- Cancel pending UpdateView_TimerProc BEFORE update to prevent ---",
                    "# it from firing during event processing and calling ConfigFBO -> FBO new,",
                    "# which fails in the unstable GL context after height bump.",
                    "catch {after cancel UpdateView_TimerProc}",
                    "# --- Process pending resize events to stabilize GL context after height bump ---",
                    "# Single 'update' is safe here: UpdateView_TimerProc is already cancelled.",
                    "# Without this, GL context remains unstable and IPG-MOVIE's internal",
                    "# UpdateView fails with 'FBO error: id not mapped'.",
                    "update",
