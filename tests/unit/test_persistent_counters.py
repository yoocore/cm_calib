...
from src.calibration.camera_calibration import BoardScoreDetail, CameraCalibrator, TotalScoreDetail
...
class TestMovieFboCaptureScript:
    def test_capture_movie_uses_gl_widget_dimensions(self, tmp_path):
        ...
        with patch("src.calibration.camera_calibration.render_dde_execute_script", side_effect=_capture_script):
    ...
    def test_capture_movie_keeps_pre_fbo_section_free_of_event_pumping(self, tmp_path):
        ...
        # verify FBO begin/end/after 100 exist in capture body
        assert any("FBO begin" in l for l in body_lines)
