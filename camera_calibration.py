        ...
        for attempt in range(attempt_count):
            ...
            script_text = render_dde_execute_script(
                ...
                [
                    ...
                    "# --- cancel any pending timer to avoid CheckViewPort recursion during View::SetSize ---",
                    "after cancel UpdateView_TimerProc",
                    "# --- force sync View dict to widget dims via height bump (prevents stale dict from triggering CheckViewPort recursion) ---",
