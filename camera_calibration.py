        ...
        for attempt in range(attempt_count):
            ...
            script_text = render_dde_execute_script(
                ...
                [
                    ...
                    "# --- cancel pending timer, then sync View dict directly (bypass View::SetSize no-op) ---",
                    "after cancel UpdateView_TimerProc",
                    "# --- write View dict directly; widget is already at target size, View::SetSize would be no-op ---",
