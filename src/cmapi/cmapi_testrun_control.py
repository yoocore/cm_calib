...
async def main() -> None:
    ...
    _MOVIE_LAUNCH_LOG_PATH = default_output_dir() / "movie_launch_debug.log"
    _MOVIE_LAUNCH_LOG_PATH.parent.mkdir(parents=True, exist_ok=True)
